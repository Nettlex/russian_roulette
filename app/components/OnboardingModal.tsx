  ...
  const steps = [
    {
      ...
      description: 'A provably fair game of chance on Base. Test your luck and compete for prizes!',
      bullets: [
        'Transparent blockchain odds',
        'Real prizes in USDC',
        'Global leaderboards',
      ],
    },
    {
      emoji: '🔫',
      title: 'How to Play',
      description: 'Pull the trigger and survive 6 rounds to win:',
      bullets: [
        '1️⃣ Connect your wallet',
        '2️⃣ Deposit USDC or ETH ($1 minimum)',
        '3️⃣ Pull the trigger (1 in 6 chance of death)',
        '4️⃣ Survive 6 pulls → Win prize pool!',
    ...
    },
    {
      ...
      bullets: [
        ...
        '🥇 Top players win biggest rewards',
